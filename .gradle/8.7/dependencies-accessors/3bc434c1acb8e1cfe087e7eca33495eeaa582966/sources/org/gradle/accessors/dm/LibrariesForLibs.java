...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxActivityComposeLibraryAccessors extends SubDependencyFactory {
    ...
    public static class AndroidxLifecycleViewmodelComposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v260</b> with <b>androidx.lifecycle:lifecycle-viewmodel-compose</b> coordinates and
         * with version reference <b>lifecycleViewmodelCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV260() {
            return create("androidx.lifecycle.viewmodel.compose.v260");
        }
    ...
    public static class AndroidxRuntimeLivedataLibraryAccessors extends SubDependencyFactory {

        public AndroidxRuntimeLivedataLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>vversion</b> with <b>androidx.compose.runtime:runtime-livedata</b> coordinates and
         * with version reference <b>runtimeLivedata</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getVversion() {
            return create("androidx.runtime.livedata.vversion");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigationCommonKtx</b> with value <b>2.8.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>runtimeLivedata</b> with value <b><version></b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
